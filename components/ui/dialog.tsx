...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      // z-[55] so the overlay sits above z-50 fixed panels (notably the
      // expanded assets panel) — otherwise opening a dialog from within
      // such a panel would dim nothing and the dialog would render below it.
      className={cn(
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        // z-[60] keeps the content one step above the overlay's z-[55].
        className={cn(
